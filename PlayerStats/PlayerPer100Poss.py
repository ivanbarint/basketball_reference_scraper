...
def ShowStats(season):
    ...
    players, pos, age, team_id, g, gs, mp, fg, fga, fg_pct, fg3, fg3a, fg3_pct, fg2, fg2a, fg2_pct, ft, fta, ft_pct, orb, drb, trb, ast, stl, blk, tov, pf, pts, ortg, drtg = ([], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [])
    ...
    unfiltered_fg = soup.find_all("td", {"data-stat":"fg_per_poss"})
    unfiltered_fga = soup.find_all("td", {"data-stat":"fga_per_poss"})
    unfiltered_fg_pct = soup.find_all("td", {"data-stat":"fg_pct"})
    unfiltered_fg3 = soup.find_all("td", {"data-stat":"fg3_per_poss"})
    unfiltered_fg3a = soup.find_all("td", {"data-stat":"fg3a_per_poss"})
    unfiltered_fg3_pct = soup.find_all("td", {"data-stat":"fg3_pct"})
    unfiltered_fg2 = soup.find_all("td", {"data-stat":"fg2_per_poss"})
    unfiltered_fg2a = soup.find_all("td", {"data-stat":"fg2a_per_poss"})
    unfiltered_fg2_pct = soup.find_all("td", {"data-stat":"fg2_pct"})
    unfiltered_ft = soup.find_all("td", {"data-stat":"ft_per_poss"})
    unfiltered_fta = soup.find_all("td", {"data-stat":"fta_per_poss"})
    unfiltered_ft_pct = soup.find_all("td", {"data-stat":"ft_pct"})
    unfiltered_orb = soup.find_all("td", {"data-stat":"orb_per_poss"})
    unfiltered_drb = soup.find_all("td", {"data-stat":"drb_per_poss"})
    unfiltered_trb = soup.find_all("td", {"data-stat":"trb_per_poss"})
    unfiltered_ast = soup.find_all("td", {"data-stat":"ast_per_poss"})
    unfiltered_stl = soup.find_all("td", {"data-stat":"stl_per_poss"})
    unfiltered_blk = soup.find_all("td", {"data-stat":"blk_per_poss"})
    unfiltered_tov = soup.find_all("td", {"data-stat":"tov_per_poss"})
    unfiltered_pf = soup.find_all("td", {"data-stat":"pf_per_poss"})
    unfiltered_pts = soup.find_all("td", {"data-stat":"pts_per_poss"})
    unfiltered_ortg = soup.find_all("td", {"data-stat":"off_rtg"})
    unfiltered_drtg = soup.find_all("td", {"data-stat":"def_rtg"})
    ...
    for i in range(0, len(unfiltered_players)):
        ...
        ortg.append(unfiltered_ortg[i].get_text(strip=True))
        drtg.append(unfiltered_drtg[i].get_text(strip=True))

    df = pd.DataFrame(list(zip(players, pos, age, team_id, g, gs, mp, fg, fga, fg_pct, fg3, fg3a, fg3_pct, fg2, fg2a, fg2_pct, ft, fta, ft_pct, orb, drb, trb, ast, stl, blk, tov, pf, pts, ortg, drtg)),
                          columns = ['Player', 'Pos', 'Age', 'Tm', 'G', 'GS', 'MP', 'FG', 'FGA', 'FG%', '3P', '3PA', '3P%', '2P', '2PA', '2P%', 'FT', 'FTA', 'FT%', 'ORB', 'DRB', 'TRB', 'AST', 'STL', 'BLK', 'TOV', 'PF', 'PTS', 'ORtg', 'DRtg'])
