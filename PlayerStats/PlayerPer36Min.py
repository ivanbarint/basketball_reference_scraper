...
def ShowStats(season):
    ...
    players, pos, age, team_id, g, gs, mp, fg, fga, fg_pct, fg3, fg3a, fg3_pct, fg2, fg2a, fg2_pct, ft, fta, ft_pct, orb, drb, trb, ast, stl, blk, tov, pf, pts = ([], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [])
    ...
    unfiltered_fg = soup.find_all("td", {"data-stat":"fg_per_mp"})
    unfiltered_fga = soup.find_all("td", {"data-stat":"fga_per_mp"})
    unfiltered_fg_pct = soup.find_all("td", {"data-stat":"fg_pct"})
    unfiltered_fg3 = soup.find_all("td", {"data-stat":"fg3_per_mp"})
    unfiltered_fg3a = soup.find_all("td", {"data-stat":"fg3a_per_mp"})
    unfiltered_fg3_pct = soup.find_all("td", {"data-stat":"fg3_pct"})
    unfiltered_fg2 = soup.find_all("td", {"data-stat":"fg2_per_mp"})
    unfiltered_fg2a = soup.find_all("td", {"data-stat":"fg2a_per_mp"})
    unfiltered_fg2_pct = soup.find_all("td", {"data-stat":"fg2_pct"})
    unfiltered_ft = soup.find_all("td", {"data-stat":"ft_per_mp"})
    unfiltered_fta = soup.find_all("td", {"data-stat":"fta_per_mp"})
    unfiltered_ft_pct = soup.find_all("td", {"data-stat":"ft_pct"})
    unfiltered_orb = soup.find_all("td", {"data-stat":"orb_per_mp"})
    unfiltered_drb = soup.find_all("td", {"data-stat":"drb_per_mp"})
    unfiltered_trb = soup.find_all("td", {"data-stat":"trb_per_mp"})
    unfiltered_ast = soup.find_all("td", {"data-stat":"ast_per_mp"})
    unfiltered_stl = soup.find_all("td", {"data-stat":"stl_per_mp"})
    unfiltered_blk = soup.find_all("td", {"data-stat":"blk_per_mp"})
    unfiltered_tov = soup.find_all("td", {"data-stat":"tov_per_mp"})
    unfiltered_pf = soup.find_all("td", {"data-stat":"pf_per_mp"})
    unfiltered_pts = soup.find_all("td", {"data-stat":"pts_per_mp"})
    ...
    df = pd.DataFrame(list(zip(players, pos, age, team_id, g, gs, mp, fg, fga, fg_pct, fg3, fg3a, fg3_pct, fg2, fg2a, fg2_pct, ft, fta, ft_pct, orb, drb, trb, ast, stl, blk, tov, pf, pts)),
                          columns = ['Player', 'Pos', 'Age', 'Tm', 'G', 'GS', 'MP', 'FG', 'FGA', 'FG%', '3P', '3PA', '3P%', '2P', '2PA', '2P%', 'FT', 'FTA', 'FT%', 'ORB', 'DRB', 'TRB', 'AST', 'STL', 'BLK', 'TOV', 'PF', 'PTS'])
