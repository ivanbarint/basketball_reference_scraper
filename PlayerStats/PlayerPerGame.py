...
def ShowStats(season):
    ...
    unfiltered_mp = soup.find_all("td", {"data-stat":"mp_per_g"})
    unfiltered_fg = soup.find_all("td", {"data-stat":"fg_per_g"})
    unfiltered_fga = soup.find_all("td", {"data-stat":"fga_per_g"})
    unfiltered_fg_pct = soup.find_all("td", {"data-stat":"fg_pct"})
    unfiltered_fg3 = soup.find_all("td", {"data-stat":"fg3_per_g"})
    unfiltered_fg3a = soup.find_all("td", {"data-stat":"fg3a_per_g"})
    unfiltered_fg3_pct = soup.find_all("td", {"data-stat":"fg3_pct"})
    unfiltered_fg2 = soup.find_all("td", {"data-stat":"fg2_per_g"})
    unfiltered_fg2a = soup.find_all("td", {"data-stat":"fg2a_per_g"})
    unfiltered_fg2_pct = soup.find_all("td", {"data-stat":"fg2_pct"})
    unfiltered_efg_pct = soup.find_all("td", {"data-stat":"efg_pct"})
    unfiltered_ft = soup.find_all("td", {"data-stat":"ft_per_g"})
    unfiltered_fta = soup.find_all("td", {"data-stat":"fta_per_g"})
    unfiltered_ft_pct = soup.find_all("td", {"data-stat":"ft_pct"})
    unfiltered_orb = soup.find_all("td", {"data-stat":"orb_per_g"})
    unfiltered_drb = soup.find_all("td", {"data-stat":"drb_per_g"})
    unfiltered_trb = soup.find_all("td", {"data-stat":"trb_per_g"})
    unfiltered_ast = soup.find_all("td", {"data-stat":"ast_per_g"})
    unfiltered_stl = soup.find_all("td", {"data-stat":"stl_per_g"})
    unfiltered_blk = soup.find_all("td", {"data-stat":"blk_per_g"})
    unfiltered_tov = soup.find_all("td", {"data-stat":"tov_per_g"})
    unfiltered_pf = soup.find_all("td", {"data-stat":"pf_per_g"})
    unfiltered_pts = soup.find_all("td", {"data-stat":"pts_per_g"})
